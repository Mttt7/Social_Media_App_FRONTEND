...
export class RegisterComponent implements OnInit {
  ...
  get passwordRepeated() { return this.credentialsFormGroup.get('credentials.passwordRepeated'); }
  get firstName() { return this.credentialsFormGroup.get('credentials.firstName'); }
  get lastName() { return this.credentialsFormGroup.get('credentials.lastName'); }
